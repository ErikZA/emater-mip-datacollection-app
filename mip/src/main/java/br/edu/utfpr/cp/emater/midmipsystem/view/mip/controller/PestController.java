...
public class PestController {
   ...
   public String listAll(Model data) {
       ...
       data.addAttribute("pestSizes", Pest.PestSize.values());
   ...
   public String create (PestDTO pest) {
       ...
       Pest pestInstance = Pest.builder().scientificName(pest.getScientificName()).usualName(pest.getUsualName()).pestSize(Pest.PestSize.valueOf(pest.getPestSize())).build();

       repository.save(pestInstance);
   ...
   public String update (PestDTO pest) {
       ...
       originalPest.setPestSize(Pest.PestSize.valueOf(pest.getPestSize()));
